...
leafwiki_updated_at: "2026-07-05T04:07:53.81863052Z"
...
- [CLI Reference](/docs/v1/cli-reference#healthd) - healthd management commands
- [Compose Compatibility](/docs/v1/compose-compatibility) - healthcheck and restart policy support
- [Architecture](/docs/v1/architecture) - how the sidecar fits the resource model
