...
leafwiki_updated_at: "2026-07-05T04:04:50.588937816Z"
...
| Variable                | Flag        | Description                                                                                              |
| ----------------------- | ----------- | -------------------------------------------------------------------------------------------------------- |
| `INCUS_COMPOSE_BUILDER` | `--builder` | Preferred builder binary or path (e.g. `podman`, `docker`); empty = auto-detect. See [Builds](/docs/v1/builds). |
...
incus-compose injects into the sidecar. See [Running ic-healthd Directly](/docs/v1/healthd#running-ic-healthd-directly).
...
- [CLI Reference](/docs/v1/cli-reference) - command options and flags
- [Compose Compatibility](/docs/v1/compose-compatibility) - interpolation and env_file support
